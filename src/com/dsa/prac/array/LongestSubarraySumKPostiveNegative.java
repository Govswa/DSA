...
public class LongestSubarraySumKPostiveNegative {
	...
	//work for positive and negative both
	...
	public static void longestSubarraySumKUsingHashingTest() {
		...
		int[] a7 = { -1, 1, 1 };
		System.out.println("***" + longestSubarraySumKUsingHashing(a7, 1));
	}
